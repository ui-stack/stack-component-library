...
var webpack = function (webpackConfig, options) {
    ...
    return __assign(__assign({}, webpackConfig), { module: __assign(__assign({}, webpackConfig.module), { rules: __spread((filteredRules || []), craRules) }), plugins: mergePlugins_1.mergePlugins(webpackConfig.plugins, craWebpackConfig.plugins), resolve: __assign(__assign({}, webpackConfig.resolve), { extensions: craWebpackConfig.resolve.extensions, modules: __spread(((webpackConfig.resolve && webpackConfig.resolve.modules) || []), [
                path_1.join(REACT_SCRIPTS_PATH, 'node_modules')
            ], getModulePath_1.getModulePath(CWD)), plugins: plugins }), resolveLoader: resolveLoader });
};
// eslint-disable-next-line import/no-default-export
exports.default = { managerWebpack: managerWebpack, webpack: webpack };
